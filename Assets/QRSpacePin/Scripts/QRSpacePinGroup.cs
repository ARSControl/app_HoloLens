...
namespace Microsoft.MixedReality.WorldLocking.Samples.Advanced.QRSpacePins
{
    ...
    public class QRSpacePinGroup : MonoBehaviour
    {
        ...
        private class SpacePinPackage
        {
            ...
            /// <remarks>
            /// The created space pin package is ready to deploy, but currently idle (=inattivo).
            /// </remarks>
            ...
            {
                if (!isSet) //se non è falso? quindi se la posizione è già stata submitted a una space pin
                {
