...
public class WISCONSIN4 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        */
        ...
        scoreText.text = "Score: " + Score4.ToString();
    ...
    public void OnTriggerEnter(Collider other)
    {
        ...
        for (int r = 0; r < primo.GetLength(0); r++)
        {
            if (other.CompareTag(primo[r, 0]))
            {
                ...
                {
                    if (primo[r, 3] == "0" && primo[r, 2] == "sphere")
                    {
                        Aumenta(primo[r, 0]);
                        primo[r, 3] = "1";
                        right.Play();
    ...
    public void Aumenta(string objectType)
    {
        ...
        string numcubi = objectType + " su vassoio 3: " + Score4.ToString() + ", " + orarioString + "\n";
