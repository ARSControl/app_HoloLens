...
public class WISCONSIN1 : MonoBehaviour
{
    ...
    public void OnTriggerEnter(Collider other)
    {
        ...
        for (int r = 0; r < primo.GetLength(0); r++)
        {
            if (other.CompareTag(primo[r, 0]))
            {
                if (firstCondition)
                {
                    if (primo[r, 3] == "0" && primo[r, 1] == "purple")
                    {
                        Aumenta(primo[r, 0]);
                        primo[r, 3] = "1";
                        right.Play();
                ...
                {
                    if (primo[r, 3] == "0" && primo[r, 2] == "cylinder")
                    {
                        Aumenta(primo[r, 0]);
                        primo[r, 3] = "1";
                        right.Play();
    ...
    public void Aumenta(string objectType)
    {
        ...
        string numcubi = objectType + " su vassoio 4: " + Score1.ToString() + ", " + orarioString + "\n";
