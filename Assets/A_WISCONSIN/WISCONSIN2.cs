...
public class WISCONSIN2 : MonoBehaviour
{
    ...
    public void Aumenta(string objectType)
    {
        ...
        string numcubi = objectType + " su vassoio 1: " + Score2.ToString() + ", " + orarioString + "\n";
